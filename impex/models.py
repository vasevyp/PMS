...
class ImpexSupplier(models.Model):
    code=models.DecimalField(max_digits=8, help_text="Не более 4 знаков", decimal_places=0, unique=True)
...
class ImpexWasteItem(models.Model):
    ...
    item_name =models.CharField(max_length=200, help_text="Не более 200 знаков", db_index=True)
    unit = models.CharField(max_length=10,verbose_name='Ед.изм.',  choices=UNITS, null=True ,default='kg')
    unit_cost=models.DecimalField(max_digits=12, help_text="Не более 12 знаков",decimal_places=2, verbose_name='Цена, руб', default=0,null=True)
    quantity= models.DecimalField(max_digits=12, help_text="Не более 12 знаков",decimal_places=0, verbose_name='Кол.',default=0)
    cost= models.DecimalField(max_digits=12, help_text="Не более 12 знаков",decimal_places=2, verbose_name='Сумма, руб', blank=True,null=True)
